        ...
        <div style={{ borderRadius: '12px', overflow: 'hidden', minHeight: '340px', height: 'auto', position: 'relative', background: '#0d1117' }}>
          ...
          {activeTab === 'stone' && (
            <div 
              ...
              style={{ minHeight: '340px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundImage: 'linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url("/sedemson_stone_hero.png")', backgroundSize: 'cover', backgroundPosition: 'center', color: '#fff', padding: '2rem 1.2rem', textAlign: 'center' }}
            >
          ...
          {activeTab === 'fashion' && (
            <div 
              key="slide-fashion"
              className="hero-slide-enter"
              style={{ minHeight: '340px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundImage: 'linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url("/emewear/emewear_hero.jpg")', backgroundSize: 'cover', backgroundPosition: 'top', color: '#fff', padding: '2rem 1.2rem', textAlign: 'center' }}
            >
          ...
          {activeTab === 'foundation' && (
            <div 
              ...
              className="hero-slide-enter"
              style={{ minHeight: '340px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundImage: 'linear-gradient(rgba(7, 30, 74, 0.78), rgba(0, 59, 153, 0.82)), url("/ansah-delali/cohort-group.jpg")', backgroundSize: 'cover', backgroundPosition: 'center', color: '#fff', padding: '2rem 1.2rem', textAlign: 'center' }}
            >
