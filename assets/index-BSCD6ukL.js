 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rd="FirebaseError";class Le extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=Rd,Object.setPrototypeOf(this,Le.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Bt.prototype.create)}}class Bt{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},i=`${this.service}/${e}`,o=this.errors[e],a=o?Cd(o,r):"Error",h=`${this.serviceName}: ${a} (${i}).`;return new Le(i,h,r)}}function Cd(n,e){return n.replace(Pd,(t,r)=>{const i=e[r];return i!=null?String(i):`<${r}?>`})}const Pd=/\{\$([^}]+)}/g;function kd(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function yt(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const i of t){if(!r.includes(i))return!1;const o=n[i],a=e[i];if(_a(o)&&_a(a)){if(!yt(o,a))return!1}else if(o!==a)return!1}for(const i of r)if(!t.includes(i))return!1;return!0}function _a(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vd=1e3,jd=2,Ld=4*60*60*1e3,Md=.5;function va(n,e=Vd,t=jd){const r=e*Math.pow(t,n),i=Math.round(Md*r*(Math.random()-.5)*2);return Math.min(Ld,r+i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var U;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(U||(U={}));const zd={debug:U.DEBUG,verbose:U.VERBOSE,info:U.INFO,warn:U.WARN,error:U.ERROR,silent:U.SILENT},$d=U.INFO,Hd={[U.DEBUG]:"log",[U.VERBOSE]:"log",[U.INFO]:"info",[U.WARN]:"warn",[U.ERROR]:"error"},Gd=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),i=Hd[e];if(i)console[i](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class si{constructor(e){this.name=e,this._logLevel=$d,this._logHandler=Gd,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in U))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?zd[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,U.DEBUG,...e),this._logHandler(this,U.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,U.VERBOSE,...e),this._logHandler(this,U.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,U.INFO,...e),this._logHandler(this,U.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,U.WARN,...e),this._logHandler(this,U.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,U.ERROR,...e),this._logHandler(this,U.ERROR,...e)}}const qd=(n,e)=>e.some(t=>n instanceof t);let wa,Ia;function Kd(){return wa||(wa=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Qd(){return Ia||(Ia=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const al=new WeakMap,rs=new WeakMap,cl=new WeakMap,$i=new WeakMap,Ss=new WeakMap;function Jd(n){const e=new Promise((t,r)=>{const i=()=>{n.removeEventListener("success",o),n.removeEventListener("error",a)},o=()=>{t(pt(n.result)),i()},a=()=>{r(n.error),i()};n.addEventListener("success",o),n.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&al.set(t,n)}).catch(()=>{}),Ss.set(e,n),e}function Yd(n){if(rs.has(n))return;const e=new Promise((t,r)=>{const i=()=>{n.removeEventListener("complete",o),n.removeEventListener("error",a),n.removeEventListener("abort",a)},o=()=>{t(),i()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",o),n.addEventListener("error",a),n.addEventListener("abort",a)});rs.set(n,e)}let is={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return rs.get(n);if(e==="objectStoreNames")return n.objectStoreNames||cl.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return pt(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Xd(n){is=n(is)}function Zd(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(Hi(this),e,...t);return cl.set(r,e.sort?e.sort():[e]),pt(r)}:Qd().includes(n)?function(...e){return n.apply(Hi(this),e),pt(al.get(this))}:function(...e){return pt(n.apply(Hi(this),e))}}function ef(n){return typeof n=="function"?Zd(n):(n instanceof IDBTransaction&&Yd(n),qd(n,Kd())?new Proxy(n,is):n)}function pt(n){if(n instanceof IDBRequest)return Jd(n);if($i.has(n))return $i.get(n);const e=ef(n);return e!==n&&($i.set(n,e),Ss.set(e,n)),e}const Hi=n=>Ss.get(n);function ll(n,e,{blocked:t,upgrade:r,blocking:i,terminated:o}={}){const a=indexedDB.open(n,e),h=pt(a);return r&&a.addEventListener("upgradeneeded",d=>{r(pt(a.result),d.oldVersion,d.newVersion,pt(a.transaction),d)}),t&&a.addEventListener("blocked",d=>t(d.oldVersion,d.newVersion,d)),h.then(d=>{o&&d.addEventListener("close",()=>o()),i&&d.addEventListener("versionchange",f=>i(f.oldVersion,f.newVersion,f))}).catch(()=>{}),h}const tf=["get","getKey","getAll","getAllKeys","count"],nf=["put","add","delete","clear"],Gi=new Map;function Ea(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Gi.get(e))return Gi.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,i=nf.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(i||tf.includes(t)))return;const o=async function(a,...h){const d=this.transaction(a,i?"readwrite":"readonly");let f=d.store;return r&&(f=f.index(h.shift())),(await Promise.all([f[t](...h),i&&d.done]))[0]};return Gi.set(e,o),o}Xd(n=>({...n,get:(e,t,r)=>Ea(e,t)||n.get(e,t,r),has:(e,t)=>!!Ea(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hn=Nf;function ul(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r={name:os,automaticDataCollectionEnabled:!0,...e},i=r.name;if(typeof i!="string"||!i)throw mt.create("bad-app-name",{appName:String(i)});if(t||(t=tl()),!t)throw mt.create("no-options");const o=Lr.get(i);if(o){if(yt(t,o.options)&&yt(r,o.config))return o;throw mt.create("duplicate-app",{appName:i})}const a=new Wd(i);for(const d of as.values())a.addComponent(d);const h=new jf(t,r,a);return Lr.set(i,h),h}function As(n=os){const e=Lr.get(n);if(!e&&n===os&&tl())return ul();if(!e)throw mt.create("no-app",{appName:n});return e}function Pe(n,e,t){let r=Df[n]??n;t&&(r+=`-${t}`);const i=r.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${r}" with version "${e}":`];i&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),et.warn(a.join(" "));return}He(new je(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lf="firebase-heartbeat-database",Mf=1,Bn="firebase-heartbeat-store";let qi=null;function hl(){return qi||(qi=ll(Lf,Mf,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Bn)}catch(t){console.warn(t)}}}}).catch(n=>{throw mt.create("idb-open",{originalErrorMessage:n.message})})),qi}async function Ff(n){try{const t=(await hl()).transaction(Bn),r=await t.objectStore(Bn).get(dl(n));return await t.done,r}catch(e){if(e instanceof Le)et.warn(e.message);else{const t=mt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});et.warn(t.message)}}}async function Sa(n,e){try{const r=(await hl()).transaction(Bn,"readwrite");await r.objectStore(Bn).put(e,dl(n)),await r.done}catch(t){if(t instanceof Le)et.warn(t.message);else{const r=mt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});et.warn(r.message)}}}function dl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uf=1024,Bf=30;class Wf{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new $f(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=Aa();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(a=>a.date===o))return;if(this._heartbeatsCache.heartbeats.push({date:o,agent:i}),this._heartbeatsCache.heartbeats.length>Bf){const a=Hf(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){et.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Aa(),{heartbeatsToSend:r,unsentEntries:i}=zf(this._heartbeatsCache.heartbeats),o=jr(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(t){return et.warn(t),""}}}function Aa(){return new Date().toISOString().substring(0,10)}function zf(n,e=Uf){const t=[];let r=n.slice();for(const i of n){const o=t.find(a=>a.agent===i.agent);if(o){if(o.dates.push(i.date),xa(t)>e){o.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),xa(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class $f{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return il()?sl().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Ff(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Sa(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Sa(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function xa(n){return jr(JSON.stringify({version:2,heartbeats:n})).length}function Hf(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let r=1;r<n.length;r++)n[r].date<t&&(t=n[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gf(n){He(new je("platform-logger",e=>new rf(e),"PRIVATE")),He(new je("heartbeat",e=>new Wf(e),"PRIVATE")),Pe(ss,Ta,n),Pe(ss,Ta,"esm2020"),Pe("fire-js","")}Gf("");var Ra=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var fl,On,pl,xr,cs,ml,gl,yl;(function(){var n,e=Object.defineProperty;function t(s){s=[typeof globalThis=="object"&&globalThis,s,typeof window=="object"&&window,typeof self=="object"&&self,typeof wr=="object"&&wr];for(var c=0;c<s.length;++c){var l=s[c];if(l&&l.Math==Math)return l}throw Error("Cannot find global object")}var r=t(this);function i(s,c){if(c)e:{var l=r;s=s.split(".");for(var p=0;p<s.length-1;p++){var T=s[p];if(!(T in l))break e;l=l[T]}s=s[s.length-1],p=l[s],c=c(p),c!=p&&c!=null&&e(l,s,{configurable:!0,writable:!0,value:c})}}i("Symbol.dispose",function(s){return s||Symbol("Symbol.dispose")}),i("Array.prototype.values",function(s){return s||function(){return this[Symbol.iterator]()}}),i("Object.entries",function(s){return s||function(c){var l=[],p;for(p in c)Object.prototype.hasOwnProperty.call(c,p)&&l.push([p,c[p]]);return l}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function h(s){var c=typeof s;return c=="object"&&s!=null||c=="function"}function d(s,c,l){return s.call.apply(s.bind,arguments)}function f(s,c,l){return f=d,f.apply(null,arguments)}function _(s,c){var l=Array.prototype.slice.call(arguments,1);return function(){var p=l.slice();return p.push.apply(p,arguments),s.apply(this,p)}}function I(s,c){function l(){}l.prototype=c.prototype,s.Z=c.prototype,s.prototype=new l,s.prototype.constructor=s,s.Ob=function(p,T,S){for(var C=Array(arguments.length-2),M=2;M<arguments.length;M++)C[M-2]=arguments[M];return c.prototype[T].apply(p,C)}}var A=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?s=>s&&AsyncContext.Snapshot.wrap(s):s=>s;function P(s){const c=s.length;if(c>0){const l=Array(c);for(let p=0;p<c;p++)l[p]=s[p];return l}return[]}function k(s,c){for(let p=1;p<arguments.length;p++){const T=arguments[p];var l=typeof T;if(l=l!="object"?l:T?Array.isArray(T)?"array":l:"null",l=="array"||l=="object"&&typeof T.length=="number"){l=s.length||0;const S=T.length||0;s.length=l+S;for(let C=0;C<S;C++)s[l+C]=T[C]}else s.push(T)}}class j{constructor(c,l){this.i=c,this.j=l,this.h=0,this.g=null}get(){let c;return this.h>0?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function O(s){a.setTimeout(()=>{throw s},0)}function $(){var s=w;let c=null;return s.g&&(c=s.g,s.g=s.g.next,s.g||(s.h=null),c.next=null),c}class B{constructor(){this.h=this.g=null}add(c,l){const p=Z.get();p.set(c,l),this.h?this.h.next=p:this.g=p,this.h=p}}var Z=new j(()=>new Ce,s=>s.reset());class Ce{constructor(){this.next=this.g=this.h=null}set(c,l){this.h=c,this.g=l,this.next=null}reset(){this.next=this.g=this.h=null}}let ie,le=!1,w=new B,m=()=>{const s=Promise.resolve(void 0);ie=()=>{s.then(y)}};function y(){for(var s;s=$();){try{s.h.call(s.g)}catch(l){O(l)}var c=Z;c.j(s),c.h<100&&(c.h++,s.next=c.g,c.g=s)}le=!1}function E(){this.u=this.u,this.C=this.C}E.prototype.u=!1,E.prototype.dispose=function(){this.u||(this.u=!0,this.N())},E.prototype[Symbol.dispose]=function(){this.dispose()},E.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function v(s,c){this.type=s,this.g=this.target=c,this.defaultPrevented=!1}v.prototype.h=function(){this.defaultPrevented=!0};var b=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var s=!1,c=Object.defineProperty({},"passive",{get:function(){s=!0}});try{const l=()=>{};a.addEventListener("test",l,c),a.removeEventListener("test",l,c)}catch{}return s}();function g(s){return/^[\s\xa0]*$/.test(s)}function pe(s,c){v.call(this,s?s.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,s&&this.init(s,c)}I(pe,v),pe.prototype.init=function(s,c){const l=this.type=s.type,p=s.changedTouches&&s.changedTouches.length?s.changedTouches[0]:null;this.target=s.target||s.srcElement,this.g=c,c=s.relatedTarget,c||(l=="mouseover"?c=s.fromElement:l=="mouseout"&&(c=s.toElement)),this.relatedTarget=c,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0),this.button=s.button,this.key=s.key||"",this.ctrlKey=s.ctrlKey,this.altKey=s.altKey,this.shiftKey=s.shiftKey,this.metaKey=s.metaKey,this.pointerId=s.pointerId||0,this.pointerType=s.pointerType,this.state=s.state,this.i=s,s.defaultPrevented&&pe.Z.h.call(this)},pe.prototype.h=function(){pe.Z.h.call(this);const s=this.i;s.preventDefault?s.preventDefault():s.returnValue=!1};var Ke="closure_listenable_"+(Math.random()*1e6|0),_i=0;function G(s,c,l,p,T){this.listener=s,this.proxy=null,this.src=c,this.type=l,this.capture=!!p,this.ha=T,this.key=++_i,this.da=this.fa=!1}function Et(s){s.da=!0,s.listener=null,s.proxy=null,s.src=null,s.ha=null}function Qe(s,c,l){for(const p in s)c.call(l,s[p],p,s)}function Th(s,c){for(const l in s)c.call(void 0,s[l],l,s)}function po(s){const c={};for(const l in s)c[l]=s[l];return c}const mo="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function go(s,c){let l,p;for(let T=1;T<arguments.length;T++){p=arguments[T];for(l in p)s[l]=p[l];for(let S=0;S<mo.length;S++)l=mo[S],Object.prototype.hasOwnProperty.call(p,l)&&(s[l]=p[l])}}function ar(s){this.src=s,this.g={},this.h=0}ar.prototype.add=function(s,c,l,p,T){const S=s.toString();s=this.g[S],s||(s=this.g[S]=[],this.h++);const C=wi(s,c,p,T);return C>-1?(c=s[C],l||(c.fa=!1)):(c=new G(c,this.src,S,!!p,T),c.fa=l,s.push(c)),c};function vi(s,c){const l=c.type;if(l in s.g){var p=s.g[l],T=Array.prototype.indexOf.call(p,c,void 0),S;(S=T>=0)&&Array.prototype.splice.call(p,T,1),S&&(Et(c),s.g[l].length==0&&(delete s.g[l],s.h--))}}function wi(s,c,l,p){for(let T=0;T<s.length;++T){const S=s[T];if(!S.da&&S.listener==c&&S.capture==!!l&&S.ha==p)return T}return-1}var Ii="closure_lm_"+(Math.random()*1e6|0),Ei={};function yo(s,c,l,p,T){if(Array.isArray(c)){for(let S=0;S<c.length;S++)yo(s,c[S],l,p,T);return null}return l=wo(l),s&&s[Ke]?s.J(c,l,h(p)?!!p.capture:!1,T):bh(s,c,l,!1,p,T)}function bh(s,c,l,p,T,S){if(!c)throw Error("Invalid event type");const C=h(T)?!!T.capture:!!T;let M=bi(s);if(M||(s[Ii]=M=new ar(s)),l=M.add(c,l,p,C,S),l.proxy)return l;if(p=Sh(),l.proxy=p,p.src=s,p.listener=l,s.addEventListener)b||(T=C),T===void 0&&(T=!1),s.addEventListener(c.toString(),p,T);else if(s.attachEvent)s.attachEvent(vo(c.toString()),p);else if(s.addListener&&s.removeListener)s.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return l}function Sh(){function s(l){return c.call(s.src,s.listener,l)}const c=Ah;return s}function _o(s,c,l,p,T){if(Array.isArray(c))for(var S=0;S<c.length;S++)_o(s,c[S],l,p,T);else p=h(p)?!!p.capture:!!p,l=wo(l),s&&s[Ke]?(s=s.i,S=String(c).toString(),S in s.g&&(c=s.g[S],l=wi(c,l,p,T),l>-1&&(Et(c[l]),Array.prototype.splice.call(c,l,1),c.length==0&&(delete s.g[S],s.h--)))):s&&(s=bi(s))&&(c=s.g[c.toString()],s=-1,c&&(s=wi(c,l,p,T)),(l=s>-1?c[s]:null)&&Ti(l))}function Ti(s){if(typeof s!="number"&&s&&!s.da){var c=s.src;if(c&&c[Ke])vi(c.i,s);else{var l=s.type,p=s.proxy;c.removeEventListener?c.removeEventListener(l,p,s.capture):c.detachEvent?c.detachEvent(vo(l),p):c.addListener&&c.removeListener&&c.removeListener(p),(l=bi(c))?(vi(l,s),l.h==0&&(l.src=null,c[Ii]=null)):Et(s)}}}function vo(s){return s in Ei?Ei[s]:Ei[s]="on"+s}function Ah(s,c){if(s.da)s=!0;else{c=new pe(c,this);const l=s.listener,p=s.ha||s.src;s.fa&&Ti(s),s=l.call(p,c)}return s}function bi(s){return s=s[Ii],s instanceof ar?s:null}var Si="__closure_events_fn_"+(Math.random()*1e9>>>0);function wo(s){return typeof s=="function"?s:(s[Si]||(s[Si]=function(c){return s.handleEvent(c)}),s[Si])}function me(){E.call(this),this.i=new ar(this),this.M=this,this.G=null}I(me,E),me.prototype[Ke]=!0,me.prototype.removeEventListener=function(s,c,l,p){_o(this,s,c,l,p)};function Ie(s,c){var l,p=s.G;if(p)for(l=[];p;p=p.G)l.push(p);if(s=s.M,p=c.type||c,typeof c=="string")c=new v(c,s);else if(c instanceof v)c.target=c.target||s;else{var T=c;c=new v(p,s),go(c,T)}T=!0;let S,C;if(l)for(C=l.length-1;C>=0;C--)S=c.g=l[C],T=cr(S,p,!0,c)&&T;if(S=c.g=s,T=cr(S,p,!0,c)&&T,T=cr(S,p,!1,c)&&T,l)for(C=0;C<l.length;C++)S=c.g=l[C],T=cr(S,p,!1,c)&&T}me.prototype.N=function(){if(me.Z.N.call(this),this.i){var s=this.i;for(const c in s.g){const l=s.g[c];for(let p=0;p<l.length;p++)Et(l[p]);delete s.g[c],s.h--}}this.G=null},me.prototype.J=function(s,c,l,p){return this.i.add(String(s),c,!1,l,p)},me.prototype.K=function(s,c,l,p){return this.i.add(String(s),c,!0,l,p)};function cr(s,c,l,p){if(c=s.i.g[String(c)],!c)return!0;c=c.concat();let T=!0;for(let S=0;S<c.length;++S){const C=c[S];if(C&&!C.da&&C.capture==l){const M=C.listener,se=C.ha||C.src;C.fa&&vi(s.i,C),T=M.call(se,p)!==!1&&T}}return T&&!p.defaultPrevented}function xh(s,c){if(typeof s!="function")if(s&&typeof s.handleEvent=="function")s=f(s.handleEvent,s);else throw Error("Invalid listener argument");return Number(c)>2147483647?-1:a.setTimeout(s,c||0)}function Io(s){s.g=xh(()=>{s.g=null,s.i&&(s.i=!1,Io(s))},s.l);const c=s.h;s.h=null,s.m.apply(null,c)}class Rh extends E{constructor(c,l){super(),this.m=c,this.l=l,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:Io(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function mn(s){E.call(this),this.h=s,this.g={}}I(mn,E);var Eo=[];function To(s){Qe(s.g,function(c,l){this.g.hasOwnProperty(l)&&Ti(c)},s),s.g={}}mn.prototype.N=function(){mn.Z.N.call(this),To(this)},mn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ai=a.JSON.stringify,Ch=a.JSON.parse,Ph=class{stringify(s){return a.JSON.stringify(s,void 0)}parse(s){return a.JSON.parse(s,void 0)}};function bo(){}function So(){}var gn={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function xi(){v.call(this,"d")}I(xi,v);function Ri(){v.call(this,"c")}I(Ri,v);var Tt={},Ao=null;function lr(){return Ao=Ao||new me}Tt.Ia="serverreachability";function xo(s){v.call(this,Tt.Ia,s)}I(xo,v);function yn(s){const c=lr();Ie(c,new xo(c))}Tt.STAT_EVENT="statevent";function Ro(s,c){v.call(this,Tt.STAT_EVENT,s),this.stat=c}I(Ro,v);function Ee(s){const c=lr();Ie(c,new Ro(c,s))}Tt.Ja="timingevent";function Co(s,c){v.call(this,Tt.Ja,s),this.size=c}I(Co,v);function _n(s,c){if(typeof s!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){s()},c)}function vn(){this.g=!0}vn.prototype.ua=function(){this.g=!1};function kh(s,c,l,p,T,S){s.info(function(){if(s.g)if(S){var C="",M=S.split("&");for(let q=0;q<M.length;q++){var se=M[q].split("=");if(se.length>1){const oe=se[0];se=se[1];const Fe=oe.split("_");C=Fe.length>=2&&Fe[1]=="type"?C+(oe+"="+se+"&"):C+(oe+"=redacted&")}}}else C=null;else C=S;return"XMLHTTP REQ ("+p+") [attempt "+T+"]: "+c+`
`+l+`
`+C})}function Nh(s,c,l,p,T,S,C){s.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+T+"]: "+c+`
`+l+`
`+S+" "+C})}function Ht(s,c,l,p){s.info(function(){return"XMLHTTP TEXT ("+c+"): "+Oh(s,l)+(p?" "+p:"")})}function Dh(s,c){s.info(function(){return"TIMEOUT: "+c})}vn.prototype.info=function(){};function Oh(s,c){if(!s.g)return c;if(!c)return null;try{const S=JSON.parse(c);if(S){for(s=0;s<S.length;s++)if(Array.isArray(S[s])){var l=S[s];if(!(l.length<2)){var p=l[1];if(Array.isArray(p)&&!(p.length<1)){var T=p[0];if(T!="noop"&&T!="stop"&&T!="close")for(let C=1;C<p.length;C++)p[C]=""}}}}return Ai(S)}catch{return c}}var ur={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Po={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},ko;function Ci(){}I(Ci,bo),Ci.prototype.g=function(){return new XMLHttpRequest},ko=new Ci;function wn(s){return encodeURIComponent(String(s))}function Vh(s){var c=1;s=s.split(":");const l=[];for(;c>0&&s.length;)l.push(s.shift()),c--;return s.length&&l.push(s.join(":")),l}function rt(s,c,l,p){this.j=s,this.i=c,this.l=l,this.S=p||1,this.V=new mn(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new No}function No(){this.i=null,this.g="",this.h=!1}var Do={},Pi={};function ki(s,c,l){s.M=1,s.A=dr(Me(c)),s.u=l,s.R=!0,Oo(s,null)}function Oo(s,c){s.F=Date.now(),hr(s),s.B=Me(s.A);var l=s.B,p=s.S;Array.isArray(p)||(p=[String(p)]),qo(l.i,"t",p),s.C=0,l=s.j.L,s.h=new No,s.g=ha(s.j,l?c:null,!s.u),s.P>0&&(s.O=new Rh(f(s.Y,s,s.g),s.P)),c=s.V,l=s.g,p=s.ba;var T="readystatechange";Array.isArray(T)||(T&&(Eo[0]=T.toString()),T=Eo);for(let S=0;S<T.length;S++){const C=yo(l,T[S],p||c.handleEvent,!1,c.h||c);if(!C)break;c.g[C.key]=C}c=s.J?po(s.J):{},s.u?(s.v||(s.v="POST"),c["Content-Type"]="application/x-www-form-urlencoded",s.g.ea(s.B,s.v,s.u,c)):(s.v="GET",s.g.ea(s.B,s.v,null,c)),yn(),kh(s.i,s.v,s.B,s.l,s.S,s.u)}rt.prototype.ba=function(s){s=s.target;const c=this.O;c&&ot(s)==3?c.j():this.Y(s)},rt.prototype.Y=function(s){try{if(s==this.g)e:{const M=ot(this.g),se=this.g.ya(),q=this.g.ca();if(!(M<3)&&(M!=3||this.g&&(this.h.h||this.g.la()||ea(this.g)))){this.K||M!=4||se==7||(se==8||q<=0?yn(3):yn(2)),Ni(this);var c=this.g.ca();this.X=c;var l=jh(this);if(this.o=c==200,Nh(this.i,this.v,this.B,this.l,this.S,M,c),this.o){if(this.U&&!this.L){t:{if(this.g){var p,T=this.g;if((p=T.g?T.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!g(p)){var S=p;break t}}S=null}if(s=S)Ht(this.i,this.l,s,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Di(this,s);else{this.o=!1,this.m=3,Ee(12),bt(this),In(this);break e}}if(this.R){s=!0;let oe;for(;!this.K&&this.C<l.length;)if(oe=Lh(this,l),oe==Pi){M==4&&(this.m=4,Ee(14),s=!1),Ht(this.i,this.l,null,"[Incomplete Response]");break}else if(oe==Do){this.m=4,Ee(15),Ht(this.i,this.l,l,"[Invalid Chunk]"),s=!1;break}else Ht(this.i,this.l,oe,null),Di(this,oe);if(Vo(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),M!=4||l.length!=0||this.h.h||(this.m=1,Ee(16),s=!1),this.o=this.o&&s,!s)Ht(this.i,this.l,l,"[Invalid Chunked Response]"),bt(this),In(this);else if(l.length>0&&!this.W){this.W=!0;var C=this.j;C.g==this&&C.aa&&!C.P&&(C.j.info("Great, no buffering proxy detected. Bytes received: "+l.length),Bi(C),C.P=!0,Ee(11))}}else Ht(this.i,this.l,l,null),Di(this,l);M==4&&bt(this),this.o&&!this.K&&(M==4?aa(this.j,this):(this.o=!1,hr(this)))}else Yh(this.g),c==400&&l.indexOf("Unknown SID")>0?(this.m=3,Ee(12)):(this.m=0,Ee(13)),bt(this),In(this)}}}catch{}finally{}};function jh(s){if(!Vo(s))return s.g.la();const c=ea(s.g);if(c==="")return"";let l="";const p=c.length,T=ot(s.g)==4;if(!s.h.i){if(typeof TextDecoder>"u")return bt(s),In(s),"";s.h.i=new a.TextDecoder}for(let S=0;S<p;S++)s.h.h=!0,l+=s.h.i.decode(c[S],{stream:!(T&&S==p-1)});return c.length=0,s.h.g+=l,s.C=0,s.h.g}function Vo(s){return s.g?s.v=="GET"&&s.M!=2&&s.j.Aa:!1}function Lh(s,c){var l=s.C,p=c.indexOf(`
`,l);return p==-1?Pi:(l=Number(c.substring(l,p)),isNaN(l)?Do:(p+=1,p+l>c.length?Pi:(c=c.slice(p,p+l),s.C=p+l,c)))}rt.prototype.cancel=function(){this.K=!0,bt(this)};function hr(s){s.T=Date.now()+s.H,jo(s,s.H)}function jo(s,c){if(s.D!=null)throw Error("WatchDog timer not null");s.D=_n(f(s.aa,s),c)}function Ni(s){s.D&&(a.clearTimeout(s.D),s.D=null)}rt.prototype.aa=function(){this.D=null;const s=Date.now();s-this.T>=0?(Dh(this.i,this.B),this.M!=2&&(yn(),Ee(17)),bt(this),this.m=2,In(this)):jo(this,this.T-s)};function In(s){s.j.I==0||s.K||aa(s.j,s)}function bt(s){Ni(s);var c=s.O;c&&typeof c.dispose=="function"&&c.dispose(),s.O=null,To(s.V),s.g&&(c=s.g,s.g=null,c.abort(),c.dispose())}function Di(s,c){try{var l=s.j;if(l.I!=0&&(l.g==s||Oi(l.h,s))){if(!s.L&&Oi(l.h,s)&&l.I==3){try{var p=l.Ba.g.parse(c)}catch{p=null}if(Array.isArray(p)&&p.length==3){var T=p;if(T[0]==0){e:if(!l.v){if(l.g)if(l.g.F+3e3<s.F)yr(l),mr(l);else break e;Ui(l),Ee(18)}}else l.xa=T[1],0<l.xa-l.K&&T[2]<37500&&l.F&&l.A==0&&!l.C&&(l.C=_n(f(l.Va,l),6e3));Fo(l.h)<=1&&l.ta&&(l.ta=void 0)}else At(l,11)}else if((s.L||l.g==s)&&yr(l),!g(c))for(T=l.Ba.g.parse(c),c=0;c<T.length;c++){let q=T[c];const oe=q[0];if(!(oe<=l.K))if(l.K=oe,q=q[1],l.I==2)if(q[0]=="c"){l.M=q[1],l.ba=q[2];const Fe=q[3];Fe!=null&&(l.ka=Fe,l.j.info("VER="+l.ka));const xt=q[4];xt!=null&&(l.za=xt,l.j.info("SVER="+l.za));const at=q[5];at!=null&&typeof at=="number"&&at>0&&(p=1.5*at,l.O=p,l.j.info("backChannelRequestTimeoutMs_="+p)),p=l;const ct=s.g;if(ct){const vr=ct.g?ct.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(vr){var S=p.h;S.g||vr.indexOf("spdy")==-1&&vr.indexOf("quic")==-1&&vr.indexOf("h2")==-1||(S.j=S.l,S.g=new Set,S.h&&(Vi(S,S.h),S.h=null))}if(p.G){const Wi=ct.g?ct.g.getResponseHeader("X-HTTP-Session-Id"):null;Wi&&(p.wa=Wi,Q(p.J,p.G,Wi))}}l.I=3,l.l&&l.l.ra(),l.aa&&(l.T=Date.now()-s.F,l.j.info("Handshake RTT: "+l.T+"ms")),p=l;var C=s;if(p.na=ua(p,p.L?p.ba:null,p.W),C.L){Uo(p.h,C);var M=C,se=p.O;se&&(M.H=se),M.D&&(Ni(M),hr(M)),p.g=C}else sa(p);l.i.length>0&&gr(l)}else q[0]!="stop"&&q[0]!="close"||At(l,7);else l.I==3&&(q[0]=="stop"||q[0]=="close"?q[0]=="stop"?At(l,7):Fi(l):q[0]!="noop"&&l.l&&l.l.qa(q),l.A=0)}}yn(4)}catch{}}var Mh=class{constructor(s,c){this.g=s,this.map=c}};function Lo(s){this.l=s||10,a.PerformanceNavigationTiming?(s=a.performance.getEntriesByType("navigation"),s=s.length>0&&(s[0].nextHopProtocol=="hq"||s[0].nextHopProtocol=="h2")):s=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=s?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Mo(s){return s.h?!0:s.g?s.g.size>=s.j:!1}function Fo(s){return s.h?1:s.g?s.g.size:0}function Oi(s,c){return s.h?s.h==c:s.g?s.g.has(c):!1}function Vi(s,c){s.g?s.g.add(c):s.h=c}function Uo(s,c){s.h&&s.h==c?s.h=null:s.g&&s.g.has(c)&&s.g.delete(c)}Lo.prototype.cancel=function(){if(this.i=Bo(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const s of this.g.values())s.cancel();this.g.clear()}};function Bo(s){if(s.h!=null)return s.i.concat(s.h.G);if(s.g!=null&&s.g.size!==0){let c=s.i;for(const l of s.g.values())c=c.concat(l.G);return c}return P(s.i)}var Wo=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Fh(s,c){if(s){s=s.split("&");for(let l=0;l<s.length;l++){const p=s[l].indexOf("=");let T,S=null;p>=0?(T=s[l].substring(0,p),S=s[l].substring(p+1)):T=s[l],c(T,S?decodeURIComponent(S.replace(/\+/g," ")):"")}}}function it(s){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let c;s instanceof it?(this.l=s.l,En(this,s.j),this.o=s.o,this.g=s.g,Tn(this,s.u),this.h=s.h,ji(this,Ko(s.i)),this.m=s.m):s&&(c=String(s).match(Wo))?(this.l=!1,En(this,c[1]||"",!0),this.o=bn(c[2]||""),this.g=bn(c[3]||"",!0),Tn(this,c[4]),this.h=bn(c[5]||"",!0),ji(this,c[6]||"",!0),this.m=bn(c[7]||"")):(this.l=!1,this.i=new An(null,this.l))}it.prototype.toString=function(){const s=[];var c=this.j;c&&s.push(Sn(c,zo,!0),":");var l=this.g;return(l||c=="file")&&(s.push("//"),(c=this.o)&&s.push(Sn(c,zo,!0),"@"),s.push(wn(l).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l=this.u,l!=null&&s.push(":",String(l))),(l=this.h)&&(this.g&&l.charAt(0)!="/"&&s.push("/"),s.push(Sn(l,l.charAt(0)=="/"?Wh:Bh,!0))),(l=this.i.toString())&&s.push("?",l),(l=this.m)&&s.push("#",Sn(l,$h)),s.join("")},it.prototype.resolve=function(s){const c=Me(this);let l=!!s.j;l?En(c,s.j):l=!!s.o,l?c.o=s.o:l=!!s.g,l?c.g=s.g:l=s.u!=null;var p=s.h;if(l)Tn(c,s.u);else if(l=!!s.h){if(p.charAt(0)!="/")if(this.g&&!this.h)p="/"+p;else{var T=c.h.lastIndexOf("/");T!=-1&&(p=c.h.slice(0,T+1)+p)}if(T=p,T==".."||T==".")p="";else if(T.indexOf("./")!=-1||T.indexOf("/.")!=-1){p=T.lastIndexOf("/",0)==0,T=T.split("/");const S=[];for(let C=0;C<T.length;){const M=T[C++];M=="."?p&&C==T.length&&S.push(""):M==".."?((S.length>1||S.length==1&&S[0]!="")&&S.pop(),p&&C==T.length&&S.push("")):(S.push(M),p=!0)}p=S.join("/")}else p=T}return l?c.h=p:l=s.i.toString()!=="",l?ji(c,Ko(s.i)):l=!!s.m,l&&(c.m=s.m),c};function Me(s){return new it(s)}function En(s,c,l){s.j=l?bn(c,!0):c,s.j&&(s.j=s.j.replace(/:$/,""))}function Tn(s,c){if(c){if(c=Number(c),isNaN(c)||c<0)throw Error("Bad port number "+c);s.u=c}else s.u=null}function ji(s,c,l){c instanceof An?(s.i=c,Hh(s.i,s.l)):(l||(c=Sn(c,zh)),s.i=new An(c,s.l))}function Q(s,c,l){s.i.set(c,l)}function dr(s){return Q(s,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),s}function bn(s,c){return s?c?decodeURI(s.replace(/%25/g,"%2525")):decodeURIComponent(s):""}function Sn(s,c,l){return typeof s=="string"?(s=encodeURI(s).replace(c,Uh),l&&(s=s.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),s):null}function Uh(s){return s=s.charCodeAt(0),"%"+(s>>4&15).toString(16)+(s&15).toString(16)}var zo=/[#\/\?@]/g,Bh=/[#\?:]/g,Wh=/[#\?]/g,zh=/[#\?@]/g,$h=/#/g;function An(s,c){this.h=this.g=null,this.i=s||null,this.j=!!c}function St(s){s.g||(s.g=new Map,s.h=0,s.i&&Fh(s.i,function(c,l){s.add(decodeURIComponent(c.replace(/\+/g," ")),l)}))}n=An.prototype,n.add=function(s,c){St(this),this.i=null,s=Gt(this,s);let l=this.g.get(s);return l||this.g.set(s,l=[]),l.push(c),this.h+=1,this};function $o(s,c){St(s),c=Gt(s,c),s.g.has(c)&&(s.i=null,s.h-=s.g.get(c).length,s.g.delete(c))}function Ho(s,c){return St(s),c=Gt(s,c),s.g.has(c)}n.forEach=function(s,c){St(this),this.g.forEach(function(l,p){l.forEach(function(T){s.call(c,T,p,this)},this)},this)};function Go(s,c){St(s);let l=[];if(typeof c=="string")Ho(s,c)&&(l=l.concat(s.g.get(Gt(s,c))));else for(s=Array.from(s.g.values()),c=0;c<s.length;c++)l=l.concat(s[c]);return l}n.set=function(s,c){return St(this),this.i=null,s=Gt(this,s),Ho(this,s)&&(this.h-=this.g.get(s).length),this.g.set(s,[c]),this.h+=1,this},n.get=function(s,c){return s?(s=Go(this,s),s.length>0?String(s[0]):c):c};function qo(s,c,l){$o(s,c),l.length>0&&(s.i=null,s.g.set(Gt(s,c),P(l)),s.h+=l.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const s=[],c=Array.from(this.g.keys());for(let p=0;p<c.length;p++){var l=c[p];const T=wn(l);l=Go(this,l);for(let S=0;S<l.length;S++){let C=T;l[S]!==""&&(C+="="+wn(l[S])),s.push(C)}}return this.i=s.join("&")};function Ko(s){const c=new An;return c.i=s.i,s.g&&(c.g=new Map(s.g),c.h=s.h),c}function Gt(s,c){return c=String(c),s.j&&(c=c.toLowerCase()),c}function Hh(s,c){c&&!s.j&&(St(s),s.i=null,s.g.forEach(function(l,p){const T=p.toLowerCase();p!=T&&($o(this,p),qo(this,T,l))},s)),s.j=c}function Gh(s,c){const l=new vn;if(a.Image){const p=new Image;p.onload=_(st,l,"TestLoadImage: loaded",!0,c,p),p.onerror=_(st,l,"TestLoadImage: error",!1,c,p),p.onabort=_(st,l,"TestLoadImage: abort",!1,c,p),p.ontimeout=_(st,l,"TestLoadImage: timeout",!1,c,p),a.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=s}else c(!1)}function qh(s,c){const l=new vn,p=new AbortController,T=setTimeout(()=>{p.abort(),st(l,"TestPingServer: timeout",!1,c)},1e4);fetch(s,{signal:p.signal}).then(S=>{clearTimeout(T),S.ok?st(l,"TestPingServer: ok",!0,c):st(l,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(T),st(l,"TestPingServer: error",!1,c)})}function st(s,c,l,p,T){try{T&&(T.onload=null,T.onerror=null,T.onabort=null,T.ontimeout=null),p(l)}catch{}}function Kh(){this.g=new Ph}function Li(s){this.i=s.Sb||null,this.h=s.ab||!1}I(Li,bo),Li.prototype.g=function(){return new fr(this.i,this.h)};function fr(s,c){me.call(this),this.H=s,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}I(fr,me),n=fr.prototype,n.open=function(s,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=s,this.D=c,this.readyState=1,Rn(this)},n.send=function(s){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const c={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};s&&(c.body=s),(this.H||a).fetch(new Request(this.D,c)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,xn(this)),this.readyState=0},n.Pa=function(s){if(this.g&&(this.l=s,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=s.headers,this.readyState=2,Rn(this)),this.g&&(this.readyState=3,Rn(this),this.g)))if(this.responseType==="arraybuffer")s.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in s){if(this.j=s.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Qo(this)}else s.text().then(this.Oa.bind(this),this.ga.bind(this))};function Qo(s){s.j.read().then(s.Ma.bind(s)).catch(s.ga.bind(s))}n.Ma=function(s){if(this.g){if(this.o&&s.value)this.response.push(s.value);else if(!this.o){var c=s.value?s.value:new Uint8Array(0);(c=this.B.decode(c,{stream:!s.done}))&&(this.response=this.responseText+=c)}s.done?xn(this):Rn(this),this.readyState==3&&Qo(this)}},n.Oa=function(s){this.g&&(this.response=this.responseText=s,xn(this))},n.Na=function(s){this.g&&(this.response=s,xn(this))},n.ga=function(){this.g&&xn(this)};function xn(s){s.readyState=4,s.l=null,s.j=null,s.B=null,Rn(s)}n.setRequestHeader=function(s,c){this.A.append(s,c)},n.getResponseHeader=function(s){return this.h&&this.h.get(s.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const s=[],c=this.h.entries();for(var l=c.next();!l.done;)l=l.value,s.push(l[0]+": "+l[1]),l=c.next();return s.join(`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let dn="12.12.0";function qf(n){dn=n}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ja(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function fn(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function bl(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ge{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(i){try{return atob(i)}catch(o){throw typeof DOMException<"u"&&o instanceof DOMException?new pp("Invalid base64 string: "+o):o}}(e);return new Ge(t)}static fromUint8Array(e){const t=function(i){let o="";for(let a=0;a<i.length;++a)o+=String.fromCharCode(i[a]);return o}(e);return new Ge(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const r=new Uint8Array(t.length);for(let i=0;i<t.length;i++)r[i]=t.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return H(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Ge.EMPTY_BYTE_STRING=new Ge("");const mp=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function jt(n){if(te(!!n,39018),typeof n=="string"){let e=0;const t=mp.exec(n);if(te(!!t,46558,{timestamp:n}),t[1]){let i=t[1];i=(i+"000000000").substr(0,9),e=Number(i)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:he(n.seconds),nanos:he(n.nanos)}}function he(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function on(n){return typeof n=="string"?Ge.fromBase64String(n):Ge.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sl="server_timestamp",Al="__type__",xl="__previous_value__",Rl="__local_write_time__";function Vs(n){var t,r;return((r=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[Al])==null?void 0:r.stringValue)===Sl}function js(n){const e=n.mapValue.fields[xl];return Vs(e)?js(e):e}function Fr(n){const e=jt(n.mapValue.fields[Rl].timestampValue);return new Y(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sm{constructor(e,t,r,i){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=i}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(i=>(r=i,this.remoteDocumentCache.getEntry(e,t))).next(i=>(r!==null&&Mn(r.mutation,i,Oe.empty(),Y.now()),i))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.getLocalViewOfDocuments(e,r,_e()).next(()=>r))}getLocalViewOfDocuments(e,t,r=_e()){const i=Ct();return this.populateOverlays(e,i,t).next(()=>this.computeViews(e,t,i,r).next(o=>{let a=Tr();return o.forEach((h,d)=>{a=a.insert(h,d.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const r=Ct();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,_e()))}populateOverlays(e,t,r){const i=[];return r.forEach(o=>{t.has(o)||i.push(o)}),this.documentOverlayCache.getOverlays(e,i).next(o=>{o.forEach((a,h)=>{t.set(a,h)})})}computeViews(e,t,r,i){let o=$r();const a=Ln(),h=function(){return Ln()}();return t.forEach((d,f)=>{const _=r.get(f.key);i.has(f.key)&&(_===void 0||_.mutation instanceof $t)?o=o.insert(f.key,f):_!==void 0?(a.set(f.key,_.mutation.getFieldMask()),Mn(_.mutation,f,_.mutation.getFieldMask(),Y.now())):a.set(f.key,Oe.empty())}),this.recalculateAndSaveOverlays(e,o).next(d=>(d.forEach((f,_)=>a.set(f,_)),t.forEach((f,_)=>h.set(f,new bm(_,a.get(f)??null))),h))}recalculateAndSaveOverlays(e,t){const r=Ln();let i=new Ae((a,h)=>a-h),o=_e();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const h of a)h.keys().forEach(d=>{const f=t.get(d);if(f===null)return;let _=r.get(d)||Oe.empty();_=h.applyToLocalView(f,_),r.set(d,_);const I=(i.get(h.batchId)||_e()).add(d);i=i.insert(h.batchId,I)})}).next(()=>{const a=[],h=i.getReverseIterator();for(;h.hasNext();){const d=h.getNext(),f=d.key,_=d.value,I=Wl();_.forEach(A=>{if(!o.has(A)){const P=Kl(t.get(A),r.get(A));P!==null&&I.set(A,P),o=o.add(A)}}),a.push(this.documentOverlayCache.saveOverlays(e,f,I))}return x.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,t,r,i){return Dp(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Op(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,i):this.getDocumentsMatchingCollectionQuery(e,t,r,i)}getNextDocuments(e,t,r,i){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,i).next(o=>{const a=i-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,i-o.size):x.resolve(Ct());let h=zn,d=o;return a.next(f=>x.forEach(f,(_,I)=>(h<I.largestBatchId&&(h=I.largestBatchId),o.get(_)?x.resolve():this.remoteDocumentCache.getEntry(e,_).next(A=>{d=d.insert(_,A)}))).next(()=>this.populateOverlays(e,f,o)).next(()=>this.computeViews(e,d,f,_e())).next(_=>({batchId:h,changes:Bl(_)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new L(t)).next(r=>{let i=Tr();return r.isFoundDocument()&&(i=i.insert(r.key,r)),i})}getDocumentsMatchingCollectionGroupQuery(e,t,r,i){const o=t.collectionGroup;let a=Tr();return this.indexManager.getCollectionParents(e,o).next(h=>x.forEach(h,d=>{const f=function(I,A){return new oi(A,null,I.explicitOrderBy.slice(),I.filters.slice(),I.limit,I.limitType,I.startAt,I.endAt)}(t,d.child(o));return this.getDocumentsMatchingCollectionQuery(e,f,r,i).next(_=>{_.forEach((I,A)=>{a=a.insert(I,A)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,r,i){let o;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next(a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,o,i))).next(a=>{o.forEach((d,f)=>{const _=f.getKey();a.get(_)===null&&(a=a.insert(_,ke.newInvalidDocument(_)))});let h=Tr();return a.forEach((d,f)=>{const _=o.get(d);_!==void 0&&Mn(_.mutation,f,Oe.empty(),Y.now()),Us(t,f)&&(h=h.insert(d,f))}),h})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rm{constructor(){this.sessionToken=Ge.EMPTY_BYTE_STRING}getSessionToken(e){return x.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,x.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vm{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=function(){return Ad()?8:up(we())>0?6:4}()}initialize(e,t){this.fs=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,r,i){const o={result:null};return this.gs(e,t).next(a=>{o.result=a}).next(()=>{if(!o.result)return this.ps(e,t,i,r).next(a=>{o.result=a})}).next(()=>{if(o.result)return;const a=new Om;return this.ys(e,t,a).next(h=>{if(o.result=h,this.As)return this.ws(e,t,a,h.size)})}).next(()=>o.result)}ws(e,t,r,i){return r.documentReadCount<this.Vs?(Kt()<=U.DEBUG&&N("QueryEngine","SDK will not create cache indexes for query:",kn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),x.resolve()):(Kt()<=U.DEBUG&&N("QueryEngine","Query:",kn(t),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.ds*i?(Kt()<=U.DEBUG&&N("QueryEngine","The SDK decides to create cache indexes for query:",kn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Nt(t))):x.resolve())}gs(e,t){if(za(t))return x.resolve(null);let r=Nt(t);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(t.limit!==null&&i===1&&(t=ps(t,null,"F"),r=Nt(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const a=_e(...o);return this.fs.getDocuments(e,a).next(h=>this.indexManager.getMinOffset(e,r).next(d=>{const f=this.Ss(t,h);return this.bs(t,f,a,d.readTime)?this.gs(e,ps(t,null,"F")):this.Ds(e,f,t,d)}))})))}ps(e,t,r,i){return za(t)||i.isEqual(J.min())?x.resolve(null):this.fs.getDocuments(e,r).next(o=>{const a=this.Ss(t,o);return this.bs(t,a,r,i)?x.resolve(null):(Kt()<=U.DEBUG&&N("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),kn(t)),this.Ds(e,a,t,sp(i,zn)).next(h=>h))})}Ss(e,t){let r=new fe(jp(e));return t.forEach((i,o)=>{Us(e,o)&&(r=r.add(o))}),r}bs(e,t,r,i){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(i)>0)}ys(e,t,r){return Kt()<=U.DEBUG&&N("QueryEngine","Using full collection scan to execute query:",kn(t)),this.fs.getDocumentsMatchingQuery(e,t,_t.min(),r)}Ds(e,t,r,i){return this.fs.getDocumentsMatchingQuery(e,r,i).next(o=>(t.forEach(a=>{o=o.insert(a.key,a)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ge="WebChannelConnection",Nn=(n,e,t)=>{n.listen(e,r=>{try{t(r)}catch(i){setTimeout(()=>{throw i},0)}})};class Xt extends Hm{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!Xt.c_){const e=gl();Nn(e,ml.STAT_EVENT,t=>{t.stat===cs.PROXY?N(ge,"STAT_EVENT: detected buffering proxy"):t.stat===cs.NOPROXY&&N(ge,"STAT_EVENT: detected no buffering proxy")}),Xt.c_=!0}}zo(e,t,r,i,o){const a=_s();return new Promise((h,d)=>{const f=new fl;f.setWithCredentials(!0),f.listenOnce(pl.COMPLETE,()=>{try{switch(f.getLastErrorCode()){case xr.NO_ERROR:const I=f.getResponseJson();N(ge,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(I)),h(I);break;case xr.TIMEOUT:N(ge,`RPC '${e}' ${a} timed out`),d(new D(R.DEADLINE_EXCEEDED,"Request time out"));break;case xr.HTTP_ERROR:const A=f.getStatus();if(N(ge,`RPC '${e}' ${a} failed with status:`,A,"response text:",f.getResponseText()),A>0){let P=f.getResponseJson();Array.isArray(P)&&(P=P[0]);const k=P==null?void 0:P.error;if(k&&k.status&&k.message){const j=function($){const B=$.toLowerCase().replace(/_/g,"-");return Object.values(R).indexOf(B)>=0?B:R.UNKNOWN}(k.status);d(new D(j,k.message))}else d(new D(R.UNKNOWN,"Server responded with status "+f.getStatus()))}else d(new D(R.UNAVAILABLE,"Connection failed."));break;default:F(9055,{l_:e,streamId:a,h_:f.getLastErrorCode(),P_:f.getLastError()})}}finally{N(ge,`RPC '${e}' ${a} completed.`)}});const _=JSON.stringify(i);N(ge,`RPC '${e}' ${a} sending request:`,i),f.send(t,"POST",_,r,15)})}T_(e,t,r){const i=_s(),o=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Go(h.initMessageHeaders,t,r),h.encodeInitMessageHeaders=!0;const f=o.join("");N(ge,`Creating RPC '${e}' stream ${i}: ${f}`,h);const _=a.createWebChannel(f,h);this.E_(_);let I=!1,A=!1;const P=new Gm({Jo:k=>{A?N(ge,`Not sending because RPC '${e}' stream ${i} is closed:`,k):(I||(N(ge,`Opening RPC '${e}' stream ${i} transport.`),_.open(),I=!0),N(ge,`RPC '${e}' stream ${i} sending:`,k),_.send(k))},Ho:()=>_.close()});return Nn(_,On.EventType.OPEN,()=>{A||(N(ge,`RPC '${e}' stream ${i} transport opened.`),P.i_())}),Nn(_,On.EventType.CLOSE,()=>{A||(A=!0,N(ge,`RPC '${e}' stream ${i} transport closed`),P.o_(),this.I_(_))}),Nn(_,On.EventType.ERROR,k=>{A||(A=!0,Wn(ge,`RPC '${e}' stream ${i} transport errored. Name:`,k.name,"Message:",k.message),P.o_(new D(R.UNAVAILABLE,"The operation could not be completed")))}),Nn(_,On.EventType.MESSAGE,k=>{var j;if(!A){const O=k.data[0];te(!!O,16349);const $=O,B=($==null?void 0:$.error)||((j=$[0])==null?void 0:j.error);if(B){N(ge,`RPC '${e}' stream ${i} received error:`,B);const Z=B.status;let Ce=function(w){const m=ne[w];if(m!==void 0)return tm(m)}(Z),ie=B.message;Z==="NOT_FOUND"&&ie.includes("database")&&ie.includes("does not exist")&&ie.includes(this.databaseId.database)&&Wn(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),Ce===void 0&&(Ce=R.INTERNAL,ie="Unknown error status: "+Z+" with message "+B.message),A=!0,P.o_(new D(Ce,ie)),_.close()}else N(ge,`RPC '${e}' stream ${i} received:`,O),P.__(O)}}),Xt.u_(),setTimeout(()=>{P.s_()},0),P}terminate(){this.a_.forEach(e=>e.close()),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter(t=>t===e)}Go(e,t,r){super.Go(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return yl()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qm(n){return new Xt(n)}function Ji(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Pe(Wg,zg,"app");function bu(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const $g=bu,Su=new Bt("auth","Firebase",bu());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tt(n,...e){throw Xs(n,...e)}function ze(n,...e){return Xs(n,...e)}function Au(n,e,t){const r={...$g(),[e]:t};return new Bt("auth","Firebase",r).create(e,{appName:n.name})}function Dt(n){return Au(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Xs(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return Su.create(n,...e)}function V(n,e,...t){if(!n)throw Xs(e,...t)}function Je(n){const e="INTERNAL ASSERTION FAILED: "+n;throw Nr(e),new Error(e)}function nt(n,e){n||Je(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ws(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function Gg(){return gc()==="http:"||gc()==="https:"}function gc(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qg(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Gg()||rl()||"connection"in navigator)?navigator.onLine:!0}function Kg(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ir{constructor(e,t){this.shortDelay=e,this.longDelay=t,nt(t>e,"Short delay should be less than long delay!"),this.isMobile=Id()||bd()}get(){return qg()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jg=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Yg=new ir(3e4,6e4);function eo(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function pn(n,e,t,r,i={}){return Ru(n,i,async()=>{let o={},a={};r&&(e==="GET"?a=r:o={body:JSON.stringify(r)});const h=Jn({key:n.config.apiKey,...a}).slice(1),d=await n._getAdditionalHeaders();d["Content-Type"]="application/json",n.languageCode&&(d["X-Firebase-Locale"]=n.languageCode);const f={method:e,headers:d,...o};return Td()||(f.referrerPolicy="no-referrer"),n.emulatorConfig&&Yn(n.emulatorConfig.host)&&(f.credentials="include"),xu.fetch()(await Cu(n,n.config.apiHost,t,h),f)})}async function Ru(n,e,t){n._canInitEmulator=!1;const r={...Qg,...e};try{const i=new Zg(n),o=await Promise.race([t(),i.promise]);i.clearNetworkTimeout();const a=await o.json();if("needConfirmation"in a)throw Ar(n,"account-exists-with-different-credential",a);if(o.ok&&!("errorMessage"in a))return a;{const h=o.ok?a.errorMessage:a.error.message,[d,f]=h.split(" : ");if(d==="FEDERATED_USER_ID_ALREADY_LINKED")throw Ar(n,"credential-already-in-use",a);if(d==="EMAIL_EXISTS")throw Ar(n,"email-already-in-use",a);if(d==="USER_DISABLED")throw Ar(n,"user-disabled",a);const _=r[d]||d.toLowerCase().replace(/[_\s]+/g,"-");if(f)throw Au(n,_,f);tt(n,_)}}catch(i){if(i instanceof Le)throw i;tt(n,"network-request-failed",{message:String(i)})}}async function Xg(n,e,t,r,i={}){const o=await pn(n,e,t,r,i);return"mfaPendingCredential"in o&&tt(n,"multi-factor-auth-required",{_serverResponse:o}),o}async function Cu(n,e,t,r){const i=`${e}${t}?${r}`,o=n,a=o.config.emulator?Zs(n.config,i):`${n.config.apiScheme}://${i}`;return Jg.includes(t)&&(await o._persistenceManagerAvailable,o._getPersistenceType()==="COOKIE")?o._getPersistence()._getFinalTarget(a).toString():a}class Zg{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r(ze(this.auth,"network-request-failed")),Yg.get())})}}function Ar(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const i=ze(n,e,r);return i.customData._tokenResponse=t,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kn(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof Le&&ny(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function ny({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wc(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Vu(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Nu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Lu(e))return"Blackberry";if(Mu(e))return"Webos";if(Du(e))return"Safari";if((e.includes("chrome/")||Ou(e))&&!e.includes("edge/"))return"Chrome";if(ju(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Nu(n=we()){return/firefox\//i.test(n)}function Du(n=we()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Ou(n=we()){return/crios\//i.test(n)}function Vu(n=we()){return/iemobile/i.test(n)}function ju(n=we()){return/android/i.test(n)}function Lu(n=we()){return/blackberry/i.test(n)}function Mu(n=we()){return/webos/i.test(n)}function no(n=we()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function cy(n=we()){var e;return no(n)&&!!((e=window.navigator)!=null&&e.standalone)}function ly(){return Sd()&&document.documentMode===10}function Fu(n=we()){return no(n)||ju(n)||Mu(n)||Lu(n)||/windows phone/i.test(n)||Vu(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qu(){return typeof $e().WorkerGlobalScope<"u"&&typeof $e().importScripts=="function"}async function jy(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Ly(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)==null?void 0:n.controller)||null}function My(){return Qu()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I_={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},E_=500,T_=600,b_="_blank",S_="http://localhost";class Rc{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function A_(n,e,t,r=E_,i=T_){const o=Math.max((window.screen.availHeight-i)/2,0).toString(),a=Math.max((window.screen.availWidth-r)/2,0).toString();let h="";const d={...I_,width:r.toString(),height:i.toString(),top:o,left:a},f=we().toLowerCase();t&&(h=Ou(f)?b_:t),Nu(f)&&(e=e||S_,d.scrollbars="yes");const _=Object.entries(d).reduce((A,[P,k])=>`${A}${P}=${k},`,"");if(cy(f)&&h!=="_self")return x_(e||"",h),new Rc(null);const I=window.open(e||"",h,_);V(I,n,"popup-blocked");try{I.focus()}catch{}return new Rc(I)}function x_(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function N0(n){if(!n.startsWith(ho)){const e=Re.create("invalid-gtag-resource",{gtagURL:n});return Te.warn(e.message),""}return n}function vh(n){return Promise.all(n.map(e=>e.catch(t=>t)))}function D0(n,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(n,e)),t}function O0(n,e){const t=D0("firebase-js-sdk-policy",{createScriptURL:N0}),r=document.createElement("script"),i=`${ho}?l=${n}&id=${e}`;r.src=t?t==null?void 0:t.createScriptURL(i):i,r.async=!0,document.head.appendChild(r)}function V0(n){let e=[];return Array.isArray(window[n])?e=window[n]:window[n]=e,e}async function j0(n,e,t,r,i,o){const a=r[i];try{if(a)await e[a];else{const d=(await vh(t)).find(f=>f.measurementId===i);d&&await e[d.appId]}}catch(h){Te.error(h)}n("config",i,o)}async function L0(n,e,t,r,i){try{let o=[];if(i&&i.send_to){let a=i.send_to;Array.isArray(a)||(a=[a]);const h=await vh(t);for(const d of a){const f=h.find(I=>I.measurementId===d),_=f&&e[f.appId];if(_)o.push(_);else{o=[];break}}}o.length===0&&(o=Object.values(e)),await Promise.all(o),n("event",r,i||{})}catch(o){Te.error(o)}}function M0(n,e,t,r){async function i(o,...a){try{if(o==="event"){const[h,d]=a;await L0(n,e,t,h,d)}else if(o==="config"){const[h,d]=a;await j0(n,e,t,r,h,d)}else if(o==="consent"){const[h,d]=a;n("consent",h,d)}else if(o==="get"){const[h,d,f]=a;n("get",h,d,f)}else if(o==="set"){const[h]=a;n("set",h)}else n(o,...a)}catch(h){Te.error(h)}}return i}function F0(n,e,t,r,i){let o=function(...a){window[r].push(arguments)};return window[i]&&typeof window[i]=="function"&&(o=window[i]),window[i]=M0(o,n,e,t),{gtagCore:o,wrappedGtag:window[i]}}function U0(n){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(ho)&&t.src.includes(n))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
